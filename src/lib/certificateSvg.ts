...
export function buildCertificateSvg(options: {
  ...
  const parts = [
    ...
    signature
      ...
      : t("Samuel Ndung'u", 586, 124, { size: fitSize("Samuel Ndung'u", "F6", 26, 15, 170), fill: NAVY, family: SERIF, style: "italic" }),
    line(496, 114, 676, 114, 0.9, NAVY),
    t("SAMUEL NDUNG'U", 586, 100, { size: 9.5, fill: NAVY, weight: "bold", spacing: 1.2 }),
    t("FOUNDER & DIRECTOR", 586, 87, { size: 7.5, fill: MUTED, weight: "bold", spacing: 1.8 }),
