...
export default async function Footer() {
  ...
  const socials = [
    { name: "Facebook", handle: "Sam Creatives", href: "https://www.facebook.com/profile.php?id=61591155443815", icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
    )},
    { name: "Instagram", handle: "@samcreativedesignschool", href: "https://www.instagram.com/samcreativedesignschool?igsh=MWNybngwYm4zdjlwZw==", icon: (
    ...
    { name: "TikTok", handle: "@samkim7", href: "https://vm.tiktok.com/ZS96QHNaQA7Mk-cBfGz/", icon: (
    ...
    { name: "LinkedIn", handle: "Samuel Ndung'u", href: "https://www.linkedin.com/in/samuel-ndung-u-20b89b41a", icon: (
