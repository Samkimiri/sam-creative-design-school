...
function ReviewCard({
  ...
  return (
    <article className="premium-card bg-white p-6 rounded-2xl shadow-sm border border-gray-100 transition-all duration-300 hover:shadow-lg motion-safe:hover:-translate-y-1" data-reveal style={{ "--reveal-delay": `${index * 55}ms` } as CSSProperties}>
      <div className="flex items-start justify-between gap-3 mb-4">
        ...
        {editable && onEdit && (
          <button
            ...
            className="premium-button inline-flex items-center gap-1.5 text-xs font-bold text-primary border border-primary/30 px-3 py-1.5 rounded-lg hover:bg-primary hover:text-white transition-all duration-300 motion-safe:hover:-translate-y-0.5"
          >
...
export default function ReviewsSection({ mode = "full" }: ReviewsSectionProps) {
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-[0.85fr_1.15fr] gap-8 items-center">
            <div data-reveal>
              ...
              <Link href="/reviews" className="premium-button inline-flex bg-primary text-white px-7 py-3 rounded-xl font-bold hover:bg-primary/90 transition-all duration-300 motion-safe:hover:-translate-y-0.5">
  ...
  return (
    <section className="py-24 bg-light-gray">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-12" data-reveal>
          <div>
          ...
          <div className="premium-card bg-white rounded-2xl border border-gray-100 px-6 py-4 shadow-sm transition-all duration-300 hover:shadow-lg motion-safe:hover:-translate-y-1" data-reveal>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-8">
          <form onSubmit={handleSubmit} className="premium-card bg-white rounded-2xl border border-gray-100 p-6 md:p-8 shadow-sm transition-all duration-300 hover:shadow-lg" data-reveal>
            <div className="flex items-start justify-between gap-4 mb-5">
              ...
              {form.id && (
                <button
                  ...
                  className="premium-button text-xs font-bold text-gray-400 hover:text-red-500"
                >
                  Cancel
                </button>
              )}
            ...
            <button
              disabled={submitting}
              className="premium-button w-full bg-primary text-white font-bold py-4 rounded-xl hover:bg-primary/90 transition-all duration-300 disabled:opacity-50 motion-safe:hover:-translate-y-0.5"
            >
