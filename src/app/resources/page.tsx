...
const resources = [
  ...
  { title: "Certificate Preview", text: "View the blank SCDS certificate design before student details are added.", href: "/certificate-preview" },
  ...
  { title: "Tool Setup Guides", text: "Prepare Photoshop, Illustrator, CapCut, VS Code, Figma, and SolidWorks before class.", href: "/tool-setup-guides" },
  { title: "Design Challenge", text: "Join weekly creative briefs, submit work, and build stronger portfolio pieces.", href: "/design-challenge" },
  { title: "Opportunities Board", text: "Explore student-ready gigs, internships, contests, and client project briefs.", href: "/opportunities" },
  { title: "Group Training", text: "Book practical creative training for schools, churches, companies, and youth groups.", href: "/corporate-training" },
  { title: "Student Leaderboard", text: "See active LMS learners ranked by lessons, quizzes, courses, and certificates.", href: "/lms/leaderboard" },
